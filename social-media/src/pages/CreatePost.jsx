        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 bg-gray-800 text-white rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
              rows="8"
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        {selectedPlatforms.length > 0 ? (
          ...
          <div className="text-center text-gray-500 py-12">
            <FaFacebook className="mx-auto text-4xl mb-4 text-gray-300" />
